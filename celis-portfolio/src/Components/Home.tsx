...
export default function Home() {
    ...
    useEffect(() => {
        const entranceAnimation = async () => {
            await animate("#blueCircle", { opacity: 1 }, { duration: 0.8, ease: easeInOut });
                ...
                <div className="mx-5">
                    ...
                    <div id="meshCircles" className="flex flex-col md:flex-row justify-center items-center gap-x-10 text-white mt-5">
                        ...
                        <div className="flex flex-col items-center">
                            <div>
                                <motion.img className="lg:w-180 md:w-100" src={meshCircle2} />
                            </div>
                            <motion.div
                        ...
                        {/* Blue Circle */}
                        <div ref={scope} className="flex flex-col items-center relative">
                            <div>
                                <motion.img
                                    id="blueCircle"

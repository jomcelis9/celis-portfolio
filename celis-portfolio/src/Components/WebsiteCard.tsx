...
const WebsiteCard: React.FC<WebsiteCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between bg-black rounded-3xl p-6 w-full h-full border border-neutral-900 gap-6 overflow-hidden bg-clip-padding">

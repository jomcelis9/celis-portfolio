...
export default function JomsCGS() {
  return (
    <div className="min-h-screen font-Satoshi bg-gray-950 text-neutral-200 font-sans py-20 px-6 md:px-12 flex flex-col items-center">
      <div className="max-w-5xl w-full">
        ...
        <div className="mt-20 w-full flex flex-col gap-16">
          <section>
            ...
            <img src="https://imgur.com/1V5EgbX.png" alt="" />
            <p className="text-neutral-400 text-xs md:text-xl m-10 leading-relaxed">
              This is my first designing a hero section ever.
            </p>
            <img src="https://imgur.com/kayynRL.png" alt="" />
            <p className="text-neutral-400 text-xs md:text-xl m-10 leading-relaxed">
              This is my first designing a hero section ever.
            </p>
            <img src="https://imgur.com/Co52WUA.png" alt="" />
            <p className="text-neutral-400 text-xs md:text-xl m-10 leading-relaxed">
